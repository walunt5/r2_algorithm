...
#夹爪动作
ACTION_GRIPPER_CLAW_OPEN = 0x0401
ACTION_GRIPPER_CLAW_CLOSE = 0x0402
...
def target_id_to_name(target_id: int) -> str:
    names = {
        ...
        TARGET_GRIPPER_CLAW: "GRIPPER_CLAW",
    }
...
def action_id_to_name(action_id: int) -> str:
    names = {
        ...
        ACTION_GRIPPER_CLAW_OPEN: "GRIPPER_CLAW_OPEN",
        ACTION_GRIPPER_CLAW_CLOSE: "GRIPPER_CLAW_CLOSE",
    }
